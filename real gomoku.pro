...
!isEmpty(BAD_CHARS) {
    ...
    message(***)
        message(*** You need to store your project in a directory without any)
    message(*** international symbols such as Chinese or Korean symbols)
    message(*** and without any punctuation such as commas.)
...
HEADERS *= "" \
    src/hello.h \
    lib/StanfordCPPLib/P1.h \
    lib/StanfordCPPLib/P2.h \
    lib/StanfordCPPLib/P3.h \
    gametreenode.h \
    gamemodel.h \
    gamemodelpriv.h \
    coordinate.h \
...
DEFINES += SPL_PROJECT_VERSION=20171001
...
# END OF FILE (this should be line #575; if not, your .pro has been changed!)
